...
abstract class EditListOfEmpWorkstationDatatsource{
  Future<EditListofEmpWorkstationModel>getEditListofEmpWorkstation( int ipdId,String token, int psid,int orgid);
}
...
class EditListOfEmpWorkstationDatatsourceImpl implements EditListOfEmpWorkstationDatatsource{
  ...
  Future<EditListofEmpWorkstationModel> getEditListofEmpWorkstation( int ipdId,String token,int psid, int orgid) async{
    ApiRequestDataModel requestbody= ApiRequestDataModel(apiFor: "edit_list_of_emp_v1",clientAuthToken: token,ipdid: ipdId,psId: psid,orgid: orgid);
