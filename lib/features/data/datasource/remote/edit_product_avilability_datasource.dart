...
abstract class EditProductAvilabilityDatasource {
  Future<EditProductAvilableQtyModel> getEditproductQty (String token,int processid,int paid, String cardno,int reworkflag,int ipdid);
}
...
class EditProductAvilableQtyDatasourceImpl extends EditProductAvilabilityDatasource {
  ...
  Future<EditProductAvilableQtyModel> getEditproductQty (String token,int processid,int paid, String cardno,int reworkflag,int ipdid) async {
      ...
      ApiRequestDataModel requestbody = ApiRequestDataModel(
          apiFor: "edit_item_process_card_wip_v1", clientAuthToken: token,processId:processid ,paId: paid,Cardno:cardno ,reworkflag: reworkflag,ipdId:ipdid );
