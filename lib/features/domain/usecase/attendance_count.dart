...
class AttendanceCountUseCases {
  ...
  Future<AttendanceEntity> execute(int id,int deptid,int psid, String token, int orgid) async {
    return await attendanceCountRepository.getAttCount(id, deptid, psid, token,  orgid);
  }
}
