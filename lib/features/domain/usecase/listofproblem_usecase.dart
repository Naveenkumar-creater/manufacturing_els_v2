...
class ListofproblemUsecase  {
  ...
  Future<ListOfProblemEntity> execute (String token, int deptid, int processid,int assetId, int orgid) {

   return  listofproblemRepository.getListofProblem(token, deptid, processid,assetId,  orgid);
  }
