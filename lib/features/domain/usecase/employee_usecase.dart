...
class EmployeeUsecase{
  ...
  Future<EmployeeEntity>execute(int processid,int deptid,int psid, String token, int orgid)async{
return  employeeRepository.getEmployeeList(processid,deptid,psid, token,  orgid);
  }
}