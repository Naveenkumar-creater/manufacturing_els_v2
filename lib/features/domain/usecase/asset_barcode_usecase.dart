...
class AssetBarcodeUsecase{
  ...
  Future<ScanAssetBarcodeEntity>execute(int pwsid,int assetId, String token, int orgid) async{
return assetBarcodeRepository.getAssetBarcode(pwsid, assetId, token,  orgid);
  }
}